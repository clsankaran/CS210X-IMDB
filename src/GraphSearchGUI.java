...
/**
 * A simple GUI to illustrate breadth-first search on movie/actor nodes in
 * Project 3.
 */
public class GraphSearchGUI extends Application {
	...
	/**
	 * Comparator for comparing String objects which may be null. Used for sorting a
	 * collection of actor/actress/movie names.
	 */
	 ...
	 * 
	 * @param nodes
	 *            the collection of Node objects to convert
	 ...
	 * Puts results into the ListView of results and also summarizes the
	 * success/failure of the search in the Label.
	 * 
	 * @param graph
	 *            the Graph of nodes on which to perform BFS
	 * @param actorsList1
	 *            the ListView containing the starting node
	 * @param actorsList2
	 *            the ListView containing the target node
	 * @param resultsList
	 *            the ListView in which to show the shortest path
	 * @param resultsLabel
	 *            the Label in which to summarize the success/failure of the search
	 */
	...
	public void start(Stage primaryStage) {
		...
		final Graph graph;
		try {
			graph = new IMDBActorsGraph("actors_first_10000_lines.list", "actresses_first_10000_lines.list");
