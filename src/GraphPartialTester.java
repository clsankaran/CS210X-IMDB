...
public class GraphPartialTester {
	...
	public void setUp () throws IOException {
		actorsGraph = new IMDBActorsGraph("/src/actors_test.list", "/src/actresses_test.list");
		moviesGraph = new IMDBMoviesGraph("/src/actors_test.list", "/src/actresses_test.list");
